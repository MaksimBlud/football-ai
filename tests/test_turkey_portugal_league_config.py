...
def test_turkey_super_lig_is_registered_but_inert():
    ...
    assert not is_operational_collection_ready("TURKEY_SUPER_LIG")


def test_primeira_liga_is_registered_but_inert():
    ...
    assert not is_operational_collection_ready("PRIMEIRA_LIGA")
