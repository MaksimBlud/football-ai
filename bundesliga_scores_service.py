"""Read Bundesliga completed scores from The Odds API."""
import requests
...
def get_bundesliga_scores(days_from=DAYS_FROM):
    ...
    r=requests.get(f"{BASE_URL}/sports/{BUNDESLIGA_RUNTIME_CONFIG.identity.odds_sport_key}/scores/",params={"apiKey":THE_ODDS_API_KEY,"daysFrom":days_from,"dateFormat":"iso"},timeout=30)
