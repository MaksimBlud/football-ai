...
def main():
    ...
    paths=write_reports(combined,a.output_dir); window,robustness=write_window_reports(combined,a.output_dir); market,incremental=write_market_incremental_reports(combined,a.output_dir); drift_detail,drift_summary=write_early_drift_reports(combined,a.output_dir)
