...
EREDIVISIE_RUNTIME_CONFIG = LeagueRuntimeConfig(
    ...
    finished_results_source=FinishedResultsSourceConfig(provider="THE_ODDS_API",competition_code="soccer_netherlands_eredivisie",season="2026-2027",season_code="2026"),
    paths=LeaguePaths(
