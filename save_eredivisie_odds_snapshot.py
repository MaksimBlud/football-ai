...
def main():
    ...
    print("EREDIVISIE ODDS SNAPSHOT SAVED"); print("snapshot rows:",len(frame)); print("local history rows:",len(history)); print("Supabase response rows:",persisted); print("quota:",result["quota"]); print("Structural V2 used:",False); print("production model used:",False)
