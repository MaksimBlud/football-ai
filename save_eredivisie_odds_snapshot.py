...
def main():
    ...
    history=save_local_history(frame); persisted=save_supabase(frame); bookmaker_rows=save_h2h_bookmaker_snapshots(result["events"],league=LEAGUE,snapshot_time_utc=now)
