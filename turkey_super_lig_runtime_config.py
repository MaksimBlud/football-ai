"""Turkey Super Lig runtime configuration for generic research infrastructure."""
...
TURKEY_SUPER_LIG_RUNTIME_CONFIG=LeagueRuntimeConfig(
    ...
    paths=LeaguePaths(
        ...
        temporal_features=ROOT/"data"/"turkey_super_lig_features_temporal.csv",
        trainable_features=ROOT/"data"/"turkey_super_lig_features_with_elo_trainable.csv",
        upcoming_fixtures=ROOT/"data"/"upcoming_matches_turkey_super_lig.csv",
        market_shadow=ROOT/"experiments"/"turkey_super_lig_market_shadow.csv",
        market_history=ROOT/"experiments"/"turkey_super_lig_market_shadow_history.csv",
        structural_shadow=ROOT/"experiments"/"turkey_super_lig_structural_v2_shadow.csv",
        structural_history=ROOT/"experiments"/"turkey_super_lig_structural_v2_shadow_history.csv",
        current_results=ROOT/"data"/"turkey_super_lig_2026_2027_results.csv"),
    ...
    structural_v2=StructuralV2Config(league_id="TURKEY_SUPER_LIG",structural_alpha=None,edge_threshold=None,min_prior_matches=5,prediction_source="STRUCTURAL_EDGE_V2_SHADOW",calibration_status="CALIBRATION_REQUIRED"),
)
TURKEY_SUPER_LIG_RUNTIME_CONFIG.validate()
