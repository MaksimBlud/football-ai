        ...
        "bookmakers": [{
            ...
            "markets": [
                _market("alternate_spreads", [
                    {"name": "Home", "point": -1.0, "price": 2.0},
                    {"name": "Away", "point": 1.0, "price": 1.9},
                    {"name": "Home", "point": -1.5, "price": 2.5},
                ...
                _market("alternate_totals_corners", [
                    {"name": "Over", "point": 9.5, "price": 1.90},
                    {"name": "Under", "point": 9.5, "price": 1.90},
                    {"name": "Over", "point": 10.5, "price": 2.40},
                    {"name": "Under", "point": 10.5, "price": 1.55},
                ]),
                _market("alternate_team_totals_corners", [
                    {"name": "Home", "description": "Over", "point": 5.5, "price": 1.95},
                    {"name": "Home", "description": "Under", "point": 5.5, "price": 1.85},
                    {"name": "Away", "description": "Over", "point": 4.5, "price": 2.00},
                    {"name": "Away", "description": "Under", "point": 4.5, "price": 1.80},
                ]),
            ],
        }],
    }
