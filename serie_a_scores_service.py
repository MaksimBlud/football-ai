"""Read Serie A completed scores from The Odds API."""
...
def get_serie_a_scores(*, days_from: int = DAYS_FROM) -> dict:
    ...
    if response.status_code != 200:
        ...
        raise RuntimeError(
            ...
            f"HTTP {response.status_code} | {payload.get('error_code')} | {payload.get('message')}"
        )
    return {
